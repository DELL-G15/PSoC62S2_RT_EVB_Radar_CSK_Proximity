...
#ifndef CY8C624ALQI_S2D42
    #error "Unexpected MPN; expected DEVICE:=CY8C624ALQI-S2D42, ADDITIONAL_DEVICES:=CYW43012TC0KFFBH. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#ifndef CYW43012TC0KFFBH
    #error "Unexpected MPN; expected DEVICE:=CY8C624ALQI-S2D42, ADDITIONAL_DEVICES:=CYW43012TC0KFFBH. There may be an inconsistency between the *.modus file and the makefile target configuration device sets."
#endif
#endif
