...
#include <TARGET_CYSBSYSKIT-DEV-01/cybsp.h>
...
int main(void)
{
    ...
    //result = cy_retarget_io_init(P6_5, P6_4, 115200);
    result = cy_retarget_io_init(P6_5, P6_4, 115200);
    ...
    result = cy_rtos_create_thread(&ifxcapsense_task,
                                       capsense_task,
                                       CAPSENSE_TASK_NAME,
                                       NULL,
									   TASK_CAPSENSE_STACK_SIZE,
									   TASK_CAPSENSE_PRIORITY,
                                       (cy_thread_arg_t)NULL);
